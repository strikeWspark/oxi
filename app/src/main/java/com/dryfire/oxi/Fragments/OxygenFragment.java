...
public class OxygenFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_oxygen,container,false);
        recyclerView = v.findViewById(R.id.oxi_oxygen_recyclerView);
        adapter = new OxygenRecyclerViewAdapter(getContext(), distributorList);
